...
meta_lr=0.0001
meta_epoch=80
meta_train_episode=600  #1000
meta_val_episode=600 #600
...
--pre_optimizer $pre_optim  --optimizer $optim --image_size 84 --gpu ${gpuid} --n_shot $N_SHOT  --model_path $MODEL_1SHOT_PATH --test_task_nums 3 --test_n_episode 1000
